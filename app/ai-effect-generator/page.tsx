...
export default function AIEffectGeneratorPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* 页面标题 */}
      <div className="relative z-10 pt-20 md:pt-20 pb-16 md:pb-16 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6 md:mb-4">{t('aiEffectGenerator')}</h1>
          <p className="hidden md:block text-base md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed px-2">
      ...
      {/* 主要内容 */}
      <div className="relative z-10 -mt-12 md:mt-0 pb-16 md:pb-20">
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto p-4 md:p-8 bg-gray-900/80 backdrop-blur-lg border border-gray-700 rounded-2xl">
          
          {/* 步骤指示器 */}
          <div className="flex justify-center items-center space-x-2 md:space-x-6 mb-6 md:mb-8">
            {[1, 2, 3, 4].map((step) => (
              <div key={step} className="flex items-center">
                ...
                {step < 4 && (
                  <div className={`w-6 md:w-12 h-0.5 mx-1 md:mx-3 transition-all duration-300 ${
          ...
          <div className="text-center mb-6 md:mb-8">
            <h3 className="text-xl md:text-2xl font-bold text-purple-400 mb-3 md:mb-4">
              {currentStep === 1 && t('step1Title')}
              {currentStep === 2 && t('step2Title')}
              {currentStep === 3 && t('step3Title')}
              {currentStep === 4 && t('generationSuccess')}
            </h3>
            <p className="hidden md:block text-gray-300 text-base md:text-lg px-2">
          ...
          {currentStep === 1 && (
            <div className="mb-8">
              {!imageFile ? (
                <div 
                  className="border-2 border-dashed border-purple-400 rounded-lg p-8 md:p-24 text-center cursor-pointer hover:border-purple-300 transition-colors min-h-[300px] md:min-h-[500px] flex flex-col items-center justify-center"
                  onClick={() => {
                    if (!checkLoginStatus()) return;
                ...
                >
                  ...
                  <p className="hidden md:block text-gray-300 mb-4 md:mb-6 text-sm md:text-base">
                    {t('dragDropImage')}
                  </p>
                  ...
                  {generatedVideoUrl ? (
                    <div className="mt-6">
                      ...
                      <div className="mt-6">
                        <video 
                          controls 
                          className="w-full max-h-64 md:max-h-96 rounded-lg mx-auto border-2 border-purple-500"
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 sm:gap-4">
            {currentStep === 1 && imageFile && (
              <Button
                ...
                className="bg-purple-600 hover:bg-purple-700 text-white px-4 md:px-6 py-2 rounded-lg w-full sm:w-auto"
              >
                {t('nextStep')}
              </Button>
            )}
            ...
            {currentStep === 2 && videoFile && (
              <Button
                ...
                className="bg-purple-600 hover:bg-purple-700 text-white px-4 md:px-6 py-2 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed w-full sm:w-auto"
              >
            ...
            {currentStep === 4 && (
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto">
                <Button
                  className="bg-green-600 hover:bg-green-700 text-white px-4 md:px-6 py-2 rounded-lg w-full sm:w-auto"
                  onClick={() => {
                ...
                <Button
                  ...
                  className="text-purple-400 border-purple-400 hover:bg-purple-400 hover:text-white px-4 md:px-6 py-2 rounded-lg w-full sm:w-auto"
                >
                  {t('regenerate')}
                </Button>
              </div>
